...
class snake_ctrl:
    ...
    # def get_Posture(self):
        ...
        try:
            response = self._call_service(request)
            ...
            self.node.get_logger().info("get_Posture error")
    ...
    def joints_limit(self, joints):
        ...
        try:
            ...
            self.node.get_logger().info("joints_limit error")
    ...
    def snake_run(self, point_y):
        ...
        try:
            ...
            self.node.get_logger().info("snake_run error")
